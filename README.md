...
[<img src="https://raw.githubusercontent.com/hydralauncher/hydra/refs/heads/main/resources/icon.png" width="144"/>](https://help.hydralauncher.gg)
  ...
  <p align="center">
    <strong>VAPOR is an open-source gaming platform created to be the single tool that you need in order to manage your gaming library. VAPOR is written in Node.js (Electron, React, Typescript), Python, and Rust.</strong>
  </p>
...
![VAPOR Home Page](./docs/screenshot.png)
...
- Save your game progress in the cloud with VAPOR Cloud
- Unlock achievements
...
VAPOR is licensed under the [MIT License](LICENSE).
